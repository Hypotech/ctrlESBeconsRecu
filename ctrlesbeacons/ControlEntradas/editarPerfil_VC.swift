...
class editarPerfil_VC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad(){
        ...
        selectorImgs.allowsEditing = true
...
//        infoUsuario.viewTabla.backgroundColor = UIColor.greenColor()
    ...
    func tomarFoto(){
        ...
        if UIImagePickerController.isSourceTypeAvailable(UIImagePickerControllerSourceType.Camera) //si hay camara disponible
        {
            ...
            var alerta = UIAlertController( title: "Atención",
                                            message: "Camara no disponible. Se abrirá la biblioteca de imagenes",
    ...
    func imagePickerController(picker: UIImagePickerController!, didFinishPickingMediaWithInfo info: [NSObject : AnyObject]!)
    {
        ...
        var imagen = info [UIImagePickerControllerOriginalImage] as? UIImage
        
        if (imagen != nil){
            
            let aspecto = imagen!.size.width / imagen!.size.height
            
            //si el aspecto del container no coince con la imagen selecionada, es necesaria recortarla
            if (view_FotoUsuario.container.frame.width / view_FotoUsuario.container.frame.height != aspecto ){
                
                var alerta = UIAlertController( title: "Atención",
                                                message: "La imagen seleccionada es demasiado grande",
                                                preferredStyle: UIAlertControllerStyle.Alert)
                ...
                datosPerfil.imagenUsuario = imagen
